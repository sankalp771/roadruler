      ...
      <div className="max-w-md mx-auto my-16 p-8 glass-panel rounded-2xl border border-gray-800 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            You must be signed in to submit hazard reports or access restricted pages.
          </p>
        </div>

        <SignInButton mode="modal">
          <button className="w-full py-3 px-6 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm transition-colors flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20">
